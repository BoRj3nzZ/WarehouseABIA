...
public class Parking extends Posicion {
	...
	/**
	 * @brief Method for waiting at parking, only one thread can access at a
	 *        time
	 */
	...
	/**
	 * @brief Method for waking up from the parking, only one thread can access
	 *        at a time
	 */
	...
	/**
	 * @brief Method for exiting from the parking, only one thread can access at
	 *        a time
	 */
